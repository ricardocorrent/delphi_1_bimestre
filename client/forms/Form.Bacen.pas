...
type
  TfrmBacen = class(TForm)
    ...
    procedure grdBacenDblClick(Sender: TObject);
  private
...
procedure TfrmBacen.grdBacenDblClick(Sender: TObject);
begin
  initialize(True, 1, 1);
end;
...
begin
  pgcBacen.Pages[AFocusIndex].Enabled := AEnabled;
  pgcBacen.Pages[AFocusIndex].Visible := AEnabled;

  pgcBacen.ActivePageIndex := AActivedIndex;
end;
